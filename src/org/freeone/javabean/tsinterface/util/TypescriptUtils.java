...
public class TypescriptUtils {
    ...
    public static String generatorInterfaceContent(Project project, PsiJavaFile psiJavaFile) {
        ...
        try {
            interfaceContent = generatorInterfaceContent(project, psiJavaFile, true, 1);
...
//                        GlobalSearchScope globalSearchScope = GlobalSearchScope.allScope(project);
                                ...
                                if (classKind != JvmClassKind.ANNOTATION && classKind != JvmClassKind.INTERFACE) {
                                    ...
                                    if ("Enum".equalsIgnoreCase(superClassType.getName())) {
                                        ...
                                        if (parent instanceof PsiJavaFile ) {
                                            ...
                                            String findClassContent = generatorInterfaceContentForPsiClass(project, psiClassParent, false, treeLevel + 1);
                                            canonicalText2TInnerClassInterfaceContent.put(canonicalText, findClassContent);
                                        }
                                    }
                                }
    ...
    public static String generatorInterfaceContentForPsiClass(Project project, PsiClass psiClassInParameters, boolean isDefault, int treeLevel) {
        StringBuilder interfaceContent = new StringBuilder();
        String defaultText = "";
        if (isDefault) {
            defaultText = "default ";
